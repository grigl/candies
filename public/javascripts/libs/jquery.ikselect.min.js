 ...
 $.fn.extend({
 	...
 	customSelect : function(options) {
	  ...
	  return this.each(function() {
			...
			$(this).remove('span.select').after('<span class="select"><span class="select-text">'+currentSelected.text()+'</span></span>').css({position:'absolute', opacity:0, fontSize:$(this).next().css('font-size')});
